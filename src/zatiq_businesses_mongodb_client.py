    ...
    def business_register(self, business_email, business_password, hours, business_name, address, website, number, image, image_aspect_ratio, features):
        ...
        if len(check_business_register) > 0:
            ...
            register_business = Zatiq_Businesses.objects(business_email=business_email).update_one(upsert=True,
             ...
             set__preferences__gluten_free=False, set__preferences__nuts_allergy=True, set__preferences__lactose_intolerant=False, set__preferences__milk_allergy=False, set__preferences__eggs_allergy=False, set__preferences__fish_allergy=False, set__preferences__crustacean_allergy=False, set__preferences__wheat_allergy=False, set__preferences__soybeans_allergy=False)
